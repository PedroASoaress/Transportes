...
public class Cadastros {
    ...
    */
    ...
    /*public int buscaCodDestinoPorNome(String nomeDestino) {
        for (int i = 0; i < cadastroDestinos.size(); i++) {
            if (cadastroDestinos.get(i).getNome().equalsIgnoreCase(nomeDestino)) {
                return i;
    ...
    */
    ...
    public Destino buscarDestinoPorNome(String nomeDestino) {
        for (int i = 0; i < cadastroDestinos.size(); i++) {
            Destino destino = cadastroDestinos.get(i);
            if (destino.getNome().equalsIgnoreCase(nomeDestino)) {
                return destino;

            }
        }
        try{
        throw new IllegalArgumentException (" Erro: CAminhao não encontrado para o nome fornecido.");
        }catch (IllegalArgumentException e) {
                System.out.println(e.getMessage());
        }
        return null;
